...
{
    /// <summary>
    /// Represents a line item within a <see cref="Cart"/>, including product, quantity, pricing,
    ...
    public class CartItem
    {
        ...
        /// <summary>
        /// Gets the unique identifier of the parent <see cref="Cart"/> to which this item belongs.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new <see cref="CartItem"/> with the specified values.
        /// </summary>
        /// <param name="id">The unique identifier for this cart item (must be non-empty GUID).</param>
        ...
        /// </exception>
        public CartItem(Guid id, Guid productId, int quantity, decimal unitPrice, decimal discountRate)
        {
            if (id == Guid.Empty)
                throw new DomainException("CartItem ID must be a valid GUID.");
        ...
        /// <summary>
        /// Sets the <see cref="CartId"/> for this item. Intended to be called by the <see cref="Cart"/> aggregate.
        /// </summary>
        /// <param name="cartId">The identifier of the parent cart.</param>
